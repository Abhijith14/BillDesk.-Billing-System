...
Public Class Form5
    ...
    Function generate_Invoice()
        ...
        generate_Invoice = "D" + My.Settings("invoice_latest")
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("Fee Dues", New Font("TIMES NEW ROMAN", 12, FontStyle.Regular), Brushes.Black, New PointF(X_ori + 110.0F, Y_ori + 315.0F))
